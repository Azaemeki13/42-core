...
/*   Updated: 2025/12/04 13:05:51 by ituriel          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Form::Form(const std::string &name, bool isigned, unsigned int g_sign, unsigned int g_execute) : name(name), isigned(isigned), g_sign(g_sign), g_execute(g_execute)
{
    gradeChecker(g_sign);
...
Form::Form(Form &other) : name(other.name), isigned(other.isigned), g_sign(other.g_sign), g_execute(other.g_execute)
{
    gradeChecker(g_sign);
    gradeChecker(g_execute);
